...
// import FormularioClienteModal from '../components/FormularioClienteModal'; // Importamos el nuevo componente
...
//     const limite = 50; // Cuántos clientes cargar por página

//     // Estados del Modal
//     const [modalAbierto, setModalAbierto] = useState(false);
//     const [clienteSeleccionado, setClienteSeleccionado] = useState<any>(null); // Guardamos el cliente a editar

//     const cargarClientes = async (pagina: number, termino: string) => {
//         try {
//             setEstaCargando(true);
//             const result = await ClientesService.obtenerClientesPaginados(pagina, limite, termino);
...
//     // ⏳ Debounce simple: Esperamos 300ms después de que el usuario deja de escribir para buscar
//     useEffect(() => {
//         const timer = setTimeout(() => {
//             // Si el usuario busca algo, regresamos a la página 1
//             setPaginaActual(1);
...
//     // Este useEffect es para cuando cambiamos de página sin cambiar la búsqueda
//     useEffect(() => {
//         cargarClientes(paginaActual, busqueda);
//     }, [paginaActual]);

//     const totalPaginas = Math.ceil(totalClientes / limite);

//     const abrirModalNuevo = () => {
//         setClienteSeleccionado(null); // Null significa Nuevo
...
//         // Simplemente recargamos la tabla manteniendo la página y búsqueda actuales
//         cargarClientes(paginaActual, busqueda);
//         setModalAbierto(false); // Cerramos el modal tras guardar exitosamente
//     };

//     return (
//         <div className="p-6 max-w-7xl mx-auto flex flex-col h-[calc(100vh-80px)] gap-5">
...
//                 </div>
//                 {/* Se mantienen exactamente los colores y estilos solicitados */}
//                 <button
...
//             {/* BARRA DE BÚSQUEDA (Separada, con anillo de selección Focus-Within) */}
...
//                 />
//                 {/* Icono X agregado para borrar directamente */}
//                 {busqueda && (
//                     <button
//                         onClick={() => setBusqueda('')}
...
//                                     <td className="p-4">
//                                         <span className="text-xs font-bold text-slate-500 bg-slate-200 px-2 py-1 rounded mr-2">{c.tipo_documento}</span>
//                                         <span className="font-mono font-bold text-slate-700">{c.numero_documento}</span>
//                                     </td>
...
//                                     </td>
//                                     <td className="p-4 text-sm text-slate-600 truncate max-w-xs">{c.direccion || '---'}</td>
//                                     <td className="p-4 text-center">
//                                         {/* Icono siempre visible y profesional */}
//                                         <button
...
//                 {/* 🌟 CONTROLES DE PAGINACIÓN (Ahora unidos al final de la tabla) */}
//                 <div className="bg-white p-4 border-t border-slate-200 flex justify-between items-center shrink-0">
//                     <p className="text-sm text-slate-500">
//                         Mostrando <span className="font-bold text-slate-700">{clientes.length}</span> de <span className="font-bold text-slate-700">{totalClientes}</span> clientes
//                     </p>
